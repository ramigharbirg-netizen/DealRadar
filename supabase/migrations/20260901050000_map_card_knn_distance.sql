create or replace function public.get_map_card_page(
  ...
  p_max_price double precision default null::double precision,
  ...
  p_cursor_price double precision default null::double precision,
  p_cursor_price_is_null boolean default null::boolean,
  p_cursor_distance double precision default null::double precision,
  p_cursor_distance_is_null boolean default null::boolean,
