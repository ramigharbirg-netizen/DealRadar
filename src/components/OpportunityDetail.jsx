...
import { commentsAPI, favoritesAPI } from '../lib/api';
                ...
                <div className="flex gap-2 overflow-x-auto pb-1">
                  {opportunity.images.map((img, index) => (
                    <div
                      ...
                      className="h-28 min-w-[170px] bg-gray-100 rounded-xl p-2 flex items-center justify-center flex-shrink-0 cursor-zoom-in"
                    >
                      <img
                        src={img}
